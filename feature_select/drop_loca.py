...
# catagorical_feature = ['Quarter', 'Offer', 'Internet Type', 'Contract', 'Payment Method']
le = LabelEncoder()
...
test_id.to_csv("loca_LGBM.csv", index=False)
...
y_pre[y_pre == 'Other'] = 5
test_id['Churn Category'] = y_pre
test_id.to_csv("loca_ADA.csv", index=False)
...
y_pre[y_pre == 'Other'] = 5
test_id['Churn Category'] = y_pre
test_id.to_csv("loca_tree.csv", index=False)