...
model = autosklearn.classification.AutoSklearnClassifier(time_left_for_this_task=600, memory_limit=None)
...
plt.savefig("10_min_pic")
test_id.to_csv("10min.csv", index=False)