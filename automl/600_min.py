...
model = autosklearn.classification.AutoSklearnClassifier(time_left_for_this_task=36000, memory_limit=None)
...
plt.savefig("600_min_pic")
test_id.to_csv("600min.csv", index=False)