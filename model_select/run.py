...
test_id.to_csv("LGBM.csv", index=False)
...
y_pre[y_pre == 'Other'] = 5
test_id['Churn Category'] = y_pre
test_id.to_csv("ADA.csv", index=False)
...
y_pre[y_pre == 'Other'] = 5
test_id['Churn Category'] = y_pre
test_id.to_csv("tree.csv", index=False)
...
# y_pre[y_pre == 'Other'] = 5
# test_id['Churn Category'] = y_pre
# test_id.to_csv("Linear SVM.csv", index=False)
...
# y_pre[y_pre == 'Other'] = 5
# test_id['Churn Category'] = y_pre
# test_id.to_csv("RBF SVM.csv", index=False)
...
y_pre[y_pre == 'Other'] = 5
test_id['Churn Category'] = y_pre
test_id.to_csv("Gaussian.csv", index=False)
...
y_pre[y_pre == 'Other'] = 5
test_id['Churn Category'] = y_pre
test_id.to_csv("decision.csv", index=False)
model = GaussianNB()
model.fit(X_train, y_train)
y_pre = model.predict(X_test)
y_pre[y_pre == 'No Churn'] = 0
...
y_pre[y_pre == 'Other'] = 5
test_id['Churn Category'] = y_pre
test_id.to_csv("Bayes.csv", index=False)
...
y_pre[y_pre == 'Other'] = 5
test_id['Churn Category'] = y_pre
test_id.to_csv("QDA.csv", index=False)